...
alat_data = [
    {
        ...
        "perawatan": "Cuci langsung setelah dipakai dengan deterjen lembut dan sikat berbulu halus. Bilas dengan air mengalir, lalu bilas akhir dengan aquades. Balikkan di atas rak pengering. Simpan di lemari datar, jangan ditumpuk. Cek keretakan sebelum digunakan untuk pemanasan.",
    ...
    },
    {
        ...
        "perawatan": "Cuci segera setelah dipakai dengan sabun lembut dan sikat halus. Bilas dengan air keran, lalu akhiri dengan aquades. Keringkan alami dengan posisi terbalik di rak pengering. Simpan di lemari khusus agar terhindar dari benturan. Selalu cek retakan sebelum digunakan kembali.",
    ...
    },
    {
        ...
        "perawatan": "Bersihkan dengan air sabun hangat menggunakan sikat buret khusus. Lepas kran saat dicuci, beri pelumas silikon sebelum dipasang kembali. Bilas dengan aquades lalu larutan yang akan digunakan. Pasang terbalik pada klem buret. Pastikan ujung tidak tersumbat dan kran tidak bocor sebelum titrasi.",
        "ukuran": "10 mL – 50 mL",
        "warna_hex": "#06b6d4",
    },
    {
        ...
        "perawatan": "Bilas segera setelah digunakan dengan air bersih. Cuci dengan sabun lembut jika terkena bahan kimia pekat. Keringkan dengan posisi terbalik. Simpan di tempat kering. Periksa karet penghisap secara berkala — ganti jika sudah mengeras atau retak.",
        "ukuran": "±1–3 mL",
        "warna_hex": "#10b981",
    },
    {
        ...
        "perawatan": "Cuci segera dengan sabun lembut dan sikat berbulu halus. Bilas dengan aquades secara menyeluruh. Keringkan alami pada posisi terbalik — jangan dioven karena merusak akurasi kalibrasi. Simpan berdiri dengan tutup sedikit terbuka. Pastikan garis tanda batas tidak pudar.",
        "ukuran": "50 mL – 2000 mL",
        "warna_hex": "#f59e0b",
    },
    {
        ...
        "perawatan": "Bersihkan langsung setelah dipakai dengan sabun dan sikat tabung reaksi. Bilas dengan air keran lalu aquades. Keringkan terbalik pada pasak rak. Simpan di rak atau kotak khusus agar tidak berbenturan. Selalu cek bagian bawah terhadap retakan halus sebelum dipanaskan.",
        "ukuran": "10 mL – 25 mL",
        "warna_hex": "#ef4444",
    },
    {
        ...
        "perawatan": "Cuci segera dengan deterjen lembut. Gunakan sikat kecil untuk bagian dalam batang sempit. Bilas dengan aquades. Letakkan terbalik di rak pengering. Simpan berdiri atau terbalik secara stabil. Pastikan ujung batang tidak gompel atau retak agar aliran tetap lancar.",
    ...
    },
    {
        ...
        "perawatan": "Bersihkan dari debu atau noda setelah dingin menggunakan kain lap basah. Lap hingga benar-benar kering untuk mencegah karat. Simpan di tempat kering dan tidak lembap. Jika mulai berkarat, bersihkan dengan sikat kawat halus lalu oleskan minyak antipanas. Pastikan ketiga kaki tetap simetris dan kokoh.",
        "ukuran": "Tinggi ±15 cm",
        "warna_hex": "#6b7280",
    },
    {
        ...
        "perawatan": "Lap bagian luar dari tumpahan spiritus setelah dingin. Potong ujung sumbu secara berkala jika sudah gosong. Isi spiritus maksimal 2/3 volume botol. Selalu matikan dengan penutup, jangan ditiup. Simpan di tempat sejuk dan jauh dari sumber panas. Cek keretakan botol sebelum dinyalakan.",
    ...
    },
    {
        ...
        "perawatan": "Cuci segera dengan air sabun lembut dan spons halus. Bilas dengan aquades. Keringkan secara miring pada rak pengering. Simpan horizontal di laci dengan pembatas lembut jika ditumpuk. Pastikan pinggiran tidak gompel atau retak sebelum digunakan.",
    ...
    },
    {
        ...
        "perawatan": "Cuci setelah dingin dengan sabun lembut dan spons. Bilas dengan aquades. Keringkan di rak atau oven. Simpan di desikator jika harus bebas kelembapan. Jangan siram cawan panas dengan air dingin (thermal shock). Cek lapisan glasir secara berkala; jika mengelupas banyak, ganti cawan.",
        "ukuran": "5 mL – 500 mL",
        "warna_hex": "#3b82f6",
    },
    {
        ...
        "perawatan": "Bersihkan dari debu dan sisa bahan setelah dingin. Cek kawat penahan apakah masih kuat dan tidak longgar. Simpan di tempat kering agar kawat tidak berkarat. Periksa bagian porselen — ganti jika sudah retak atau pecah karena dapat mengurangi kestabilan.",
    ...
    },
    {
        ...
        "perawatan": "Oleskan sedikit vaselin pada bibir penutup secara berkala agar kedap udara. Ganti silika gel jika sudah berubah warna (jenuh). Selalu geser penutup sebelum diangkat. Simpan di tempat stabil. Bersihkan bagian dalam dengan kain kering. Cek retakan kaca sebelum digunakan dalam kondisi vakum.",
        "ukuran": "50 mL – 2000 mL",
        "warna_hex": "#3b82f6",
    },
    {
        ...
        "perawatan": "Rendam segera dalam air sabun, bersihkan dengan sikat pipet tipis. Bilas dengan aquades dari atas hingga ujung bawah. Simpan tegak lurus (ujung bawah) pada rak pipet. Simpan di laci berlapis kain lembut. Pastikan skala tidak pudar dan ujung tidak retak.",
        "ukuran": "5 mL – 50 mL",
        "warna_hex": "#3b82f6",
    },
    {
        ...
        "perawatan": "Rendam dalam air sabun ringan segera setelah digunakan. Bilas dengan aquades menyeluruh. Keringkan tegak lurus (ujung runcing ke bawah) pada rak pipet. Simpan horizontal di laci berlapis bahan lembut. Jangan keringkan di oven panas — merusak akurasi volume.",
        "ukuran": "5  mL – 100 mL",
        "warna_hex": "#3b82f6",
    },
]
...
def render_instrumen_analitik():
    ...
    <div style="background:linear-gradient(135deg,rgba(59,130,246,0.15),rgba(139,92,246,0.15));
         ...
         padding:32px 40px;margin-bottom:32px;text-align:center;">
        <h1 style="font-size:2.2rem;margin:0 0 10px 0;">🔬 Instrumen Analitik Laboratorium</h1>
        <p style="color:#94a3b8;font-size:1.05rem;margin:0;">Peralatan canggih untuk analisis kimia tingkat lanjut</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    tampil = instrumen_data if filter_kat == "Semua" else [i for i in instrumen_data if i["kategori"] == filter_kat]
    st.markdown(f"<p style='color:#64748b;font-size:13px;'>Menampilkan {len(tampil)} instrumen</p>", unsafe_allow_html=True)
        ...
        with st.expander(f"{instrumen['emoji']}  {instrumen['nama']} — {instrumen['nama_lengkap']}", expanded=False):
            ...
            with col_foto:
                try:
                    ...
                    st.markdown(f"<div style='text-align:center;padding:40px;font-size:60px'>{instrumen['emoji']}</div>", unsafe_allow_html=True)
            ...
            # Cara kerja & bahaya berdampingan
            st.markdown("<br>", unsafe_allow_html=True)
            col_cara, col_bahaya = st.columns(2, gap="medium")
            with col_cara:
                langkah_html = "".join(f"<li style='margin-bottom:6px;'>{l}</li>" for l in instrumen["cara_kerja"])
                st.markdown(f"""
                ...
                """, unsafe_allow_html=True)
            with col_bahaya:
                bahaya_html = "".join(f"<li style='margin-bottom:6px;'>{b}</li>" for b in instrumen["bahaya"])
                st.markdown(f"""
...
# =========================
    ...
    <div style="text-align:center; padding: 32px 0 16px 0;">
        <h1 style="font-size:2rem; margin-bottom:8px;">ℹ️ Tentang Kami</h1>
        <p style="color:#64748b; font-size:15px;">Aplikasi ini dibuat untuk membantu memahami alat laboratorium kimia secara interaktif.</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div style="background:rgba(59,130,246,0.1);border:1px solid rgba(59,130,246,0.3);
        ...
        <div style="font-size:18px;font-weight:700;color:#60a5fa;">Kelas 1A</div>
        <div style="color:#94a3b8;font-size:14px;margin-top:6px;">Program Studi Analisis Kimia — Politeknik AKA Bogor</div>
    </div>
    """, unsafe_allow_html=True)

    st.markdown("### 👥 Anggota Tim")
    anggota = [
        {"nama": "Adam Pastika Samas",       "nim": "2560553", "emoji": "👨‍🔬"},
        {"nama": "Cesilya Putri Mardita",     "nim": "2560599", "emoji": "👩‍🔬"},
        {"nama": "Moch Langit Azmi Alifi",    "nim": "2560672", "emoji": "👨‍🔬"},
        {"nama": "Sarah Nabila Muhayyar",     "nim": "2560773", "emoji": "👩‍🔬"},
        {"nama": "Octavia",                   "nim": "2560734", "emoji": "👩‍🔬"},
    ]
    ...
    for a in anggota:
        ...
        <div style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);
            ...
            <span style="font-size:16px;font-weight:700;color:#f1f5f9;margin-left:12px;">{a["nama"]}</span>
            <span style="font-size:13px;color:#64748b;margin-left:12px;">NIM: {a["nim"]}</span>
        </div>
        """, unsafe_allow_html=True)

    st.markdown("""
    <div style="text-align:center;margin-top:32px;color:#334155;font-size:13px;
         border-top:1px solid rgba(255,255,255,0.06);padding-top:20px;">
        ⚗️ Pengenalan Alat Laboratorium Kimia • Politeknik AKA Bogor • 2025/2026
    </div>
    """, unsafe_allow_html=True)
